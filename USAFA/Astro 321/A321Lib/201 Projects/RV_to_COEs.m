%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% RV_to_COEs calcualtes the COE's of a satellite given a position and
% velocity.
%
% Author: Scott Dahlke  USAFA/DFAS  719-333-4110
%
% Inputs:
%   file containing sets of R & V
% Outputs:
%   file containing the calcualted COE's
%
% Globals: WGS84Data
%
% Constants: None
%
% Coupling: ElOrb,calcextra
% 
% References:
...
fidi=fopen('RV1.dat','rt');
fido=fopen('test.dat','wt');

% set up thd counter and loop until all the data is done
counter = 1;
while ~feof(fidi)
  % read the first R and V  
  R=fscanf(fidi,'%f',3);
  V=fscanf(fidi,'%f',3);

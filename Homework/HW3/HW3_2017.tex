...
\begin{prob}
    ...
    \begin{subprob}
        ...
        \item Determine the period \( P \), angular momentum vector \( \bar h \), semi-latus rectum \( p \), specific mechanical energy \( \varepsilon \), eccentricity \( e \), true anomoly \( \nu \), and radius of periapsis and apoapsis \( r_p, r_a\).
        ...
        \item By hand, or with Python, sketch a diagram of the orbital plane and the location of Cassini.
...
\begin{prob}
    ...
    He is the CEO of Tesla Motors and SpaceX and is planning on sending missions to Mars.
...
\begin{prob}
    For the given orbital data below, identify the type of orbit (elliptical, circular, parabolic, or hyperbolic).

    \begin{subprob}
        \item \( \bar r = \begin{bmatrix} 6372.0 & 6372.0 & 0 \end{bmatrix}\si{\kilo\meter}\), \( \bar v = \begin{bmatrix} -4.7028 & 4.7028 & 0 \end{bmatrix} \si{\kilo\meter\per\second\squared} \)
        \item \( \bar e = \begin{bmatrix} 0.07 & 0.02 & 0.021 \end{bmatrix} \)

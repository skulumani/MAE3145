...
\begin{prob}
    \textbf{20pt} Mark whether each statement written in \textit{italic font} is True or False.
\begin{subprob}
...
\vspace*{1cm}
Write the name of the appropriate scientist who made the following statements.

    \item The force of gravity between two bodies is directly proportional to the product of their two masses and inversely proprtional to the square of the distance between them.

    \vspace*{1cm}

    \item The orbits of the planets are ellipses with the Sun at one focus.

    \vspace*{1cm}

    \item Defined the theory of epicycles, or described the apparent motion of the planets as composed of circular motion of the planet (epicycle) on a larger circle (deferent) centered on the Earth.
